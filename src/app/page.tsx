        ...
        <div id="contact" className="mt-6 scroll-mt-24">
          ...
          <div className="flex flex-wrap gap-1.5">
            {[
              ...
              { name: 'Discord', href: 'https://discord.com/channels/@shivrajxd', icon: <path d="M18 5c-1.5-.7-3.2-1-5-1s-3.5.3-5 1c-1.5 3.5-2.5 8-2.5 8 1.5 2 4.5 3 7.5 3s6-1 7.5-3c0 0-1-4.5-2.5-8zM9 13c-.8 0-1.5-.7-1.5-1.5S8.2 10 9 10s1.5.7 1.5 1.5S9.8 13 9 13zm6 0c-.8 0-1.5-.7-1.5-1.5s.7-1.5 1.5-1.5 1.5.7 1.5 1.5-.7 1.5-1.5 1.5z" fill="currentColor"></path> },
            ].map((social, i) => (
            ...
            <SocialHoverCard socialName="Medium">
              <SoftPillButton
                as="a"
                href="https://medium.com/@timilsenashivraj598"
                target="_blank"
                rel="noopener noreferrer"
                variant="secondary"
                className="px-3 py-1.5 !text-[12px]"
